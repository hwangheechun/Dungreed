...
void Weapon::Render()
{
	...
	_D2DRenderer->RenderText(1400, 355, L"무기 위치 x : " + to_wstring(_position.x), 15);
	_D2DRenderer->RenderText(1400, 375, L"무기 위치 Y : " + to_wstring(_position.y), 15); 
...
void Weapon::SetPosition(Vector2 _pos)
{
	_position = _pos;
}
